...
<a href="#" class="header_text"><p id="header-text" class="text-muted">Онлайн<span style="color:yellow">Чат</span></p></a>
</span>
</div>
...
<span style="color:white; margin-top:3px"><em>Добро пожаловать,&nbsp;</em></span>
...
<div class="mycontainer">
    ...
    <div class="navigations">
        <ul class="lists">
            ...
            <li><a href="../General_Message/General_Message.php"><img src="../img/chat-1.png" class="navimg img-responsive" /><span class="nav-writting">Онлайн чат</span></a></li>
            <li><a style="border-left:4px solid rgba(138, 43, 226, 0.93); border-radius:10px" href="Private_Message.php"><img src="../img/send-file.png" class="navimg img-responsive" /><span class="nav-writting">Приватный чат</span></a></li>
    ...
    <textarea id="text_area" placeholder="Введите ваше сообщение..." name="txtmessage"></textarea><img src="../img/send.png" alt="Send Image" id="send_button"/>
