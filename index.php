...
if (isset($_POST["submit"])) {
	...
	if ($user_validity > 0) {
        ...
        $_SESSION["err"] = "Неверное имя Пользователя или пароль";
    }
...
<body>
  ...
  <div class="flex-row">
    <input id="username" class='lf--input' placeholder='Имя' type='text' name="txtUsername">
  </div>
  <div class="flex-row">
    <input id="password" class='lf--input' placeholder='Пороль' type='password' name="txtPassword">
  </div>
  <input class='lf--submit' type='submit' value='Залогинится' name="submit" id="btnSubmit">

	  <p style="font-size:.7em;color:#2dc6bf;text-align:center;cursor:hand"><u><a style="color:#2dc6bf" href="users_signup.php">Зарегистрироваться</a></u></p>
